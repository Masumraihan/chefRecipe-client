      ...
      <div className='pb-12 container mx-auto grid  md:grid-cols-2 items-center'>
        <div className='flex flex-col gap-3'>
          ...
          >
            ...
            <div className='collapse-content'>
              <p>
                ...
                and behavior controlled by parent component.These components
                rely on props passed down from the parent component to update
                their state and behavior <br />
          ...
          >
            ...
            <div className='collapse-content'>
              <p>
                if You need to validate your props. You can define the PropTypes
                for your component using the propTypes static property, which is
                an object that contains key-value pairs for each prop and its
                expected data type. You can use the PropTypes library to define
                various types of data, including strings, numbers, booleans,
                arrays, and objects
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className='collapse-content'>
              <p>
                ...
                special and unique functionality to the applications. it can be
                ...
                code as a custom hook does not need to be rendered again and
